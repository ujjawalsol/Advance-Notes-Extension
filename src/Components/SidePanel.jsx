      ...
      >
        ...
        <nav className="flex flex-col space-y-4">
          <Link to="/" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Home</span>
          </Link>
          <Link to="/blank" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Blank Page</span>
          </Link>
          <Link to="/video" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Video Storage</span>
          </Link>
          <Link to="/image" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Image Storage</span>
          </Link>
          <Link to="/code" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Code Storage</span>
          </Link>
          <Link to="/other" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Other Files</span>
          </Link>
          <Link to="/link" onClick={togglePanel} className="group relative flex items-center justify-center cursor-pointer">
            ...
            <span className={`absolute left-16 w-28 transition-opacity duration-300 rounded-md px-2 py-1 text-sm ${isOpen ? 'opacity-0 group-hover:opacity-100' : 'opacity-0'} ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'}`}>Links</span>
          </Link>
        </nav>
      </div>
    </>
