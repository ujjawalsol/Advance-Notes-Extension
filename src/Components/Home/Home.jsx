...
const noteData = [
    {
        ...
        gradient: 'from-indigo-300 to-indigo-100 dark:from-indigo-900 dark:to-indigo-700',
    },
    {
        id: 'VideoStorage',
        title: 'Video Storage',
        ...
        gradient: 'from-red-300 to-red-100 dark:from-red-900 dark:to-red-700',
    },
    {
        id: 'ImageStorage',
        title: 'Image Storage',
        ...
        gradient: 'from-green-300 to-green-100 dark:from-green-900 dark:to-green-700',
    },
    {
        id: 'CodeSpace',
        title: 'Code Space',
        ...
        gradient: 'from-purple-300 to-purple-100 dark:from-purple-900 dark:to-purple-700',
    },
    {
        id: 'OtherFiles',
        title: 'Other Files',
        ...
        gradient: 'from-yellow-300 to-yellow-100 dark:from-yellow-900 dark:to-yellow-700',
    },
    {
        id: 'LinkStorage',
        title: 'Link Storage',
        ...
        gradient: 'from-blue-300 to-blue-100 dark:from-blue-900 dark:to-blue-700',
    },
];
            ...
            {noteData.map((note) => (
                <div
                    ...
                    className={`relative p-4 sm:p-6 md:p-8 rounded-xl shadow-lg transition-all duration-500 transform perspective-1000
                        ...
                        bg-gradient-to-r  ${note.gradient}`}
                    onClick={() => navigate(`/saved-notes/${note.id}`)}
                    style={{
                ...
                >
                    ...
                    <h2 className="text-xl sm:text-2xl font-semibold mt-4 text-black dark:text-white">{note.title}</h2>
